  ...
  <div class="w-full mt-5 bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
    ...
    <div class="grid grid-cols-1 items-center border-gray-200 border-t dark:border-gray-700 justify-between">
      <div class="flex justify-between items-center pt-5">
        ...
        <form action="<?= env('BASEURL') ?>/prestasi/exportReport" method="POST">
          <button type="submit" name="export" class="uppercase cursor-pointer text-sm font-semibold inline-flex items-center rounded-lg text-blue-600 hover:text-blue-700 dark:hover:text-blue-500  hover:bg-gray-100 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700 px-3 py-2">Export Report</button>
        </form>
      </div>
    </div>
  </div>