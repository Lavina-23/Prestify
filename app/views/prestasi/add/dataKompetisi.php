...
<!-- Form -->
<form method="post" action="<?= env("BASEURL") ?>/prestasi/addDataKompetisi" enctype="multipart/form-data" class="max-w-xl mx-auto">
  ...
  <div class="flex w-full rounded-md shadow-sm mb-5" role="group">
    ...
    <input type="text" oninput="setKategori(this.value)" placeholder="Lainnya" class="inline-flex gap-2 w-full justify-center items-center px-4 py-2 text-sm font-medium text-gray-900 bg-transparent border border-gray-900 rounded-e-lg hover:bg-gray-900 hover:text-white focus:z-10 focus:ring-2 focus:ring-gray-500 focus:bg-gray-900 focus:text-white dark:border-white dark:text-white dark:hover:text-white dark:hover:bg-gray-700 dark:focus:bg-gray-700">
    </input>
  </div>
  ...
  <div class="flex gap-4">
    ...
    <div class="grid">
      ...
      <select name="tingkat" id="tingkat" onchange="setTingkat(this.value)" class="w-44 text-white bg-gray-900 hover:bg-gray-800 font-medium rounded-lg text-sm px-5 py-2.5 text-left inline-flex items-center justify-between focus:ring-0 focus:ring-transparent">
