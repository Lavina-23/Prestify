<div class="h-full md:h-screen w-full p-10 pr-96">
  <div class="grid md:flex items-center justify-between h-24">
    ...
    <div class="flex items-center gap-2">
      <span class="text-sm font-normal text-gray-900"><?= date("l, d M Y") ?></span>
  ...
  <div class="flex justify-between flex-wrap">
    <div>
      <a href="#" class="flex gap-4 items-center w-56 p-4 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
